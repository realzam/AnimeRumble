...
import { Dices, Grid3x3, Users } from 'lucide-react';
...
const Sidebar = ({ active = 'quizzes' }: Props) => {
	return (
		<div className='space-y-4 py-4 pb-12'>
			<div className='px-3 py-2'>
				...
				<div className='space-y-1'>
					<Button
						variant={active === 'quizzes' ? 'default' : 'ghost'}
					...
					<Button
						...
						asChild
					>
						<NextLink href={animeRumbleRoutes.dashboardMembers}>
