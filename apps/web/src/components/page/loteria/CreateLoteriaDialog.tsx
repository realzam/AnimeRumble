...
const CreateLoteriaDialog = ({ id }: Props) => {
	const { searchList, replaceCard } = usePlayLoteria();
	...
	return (
		<Dialog>
			<DialogTrigger asChild>
				<Button className='absolute -right-4 -top-4 h-9 w-9 rounded-full p-[6px] text-white hover:scale-[1.05] hover:bg-purple-600'>
...
export default CreateLoteriaDialog;
