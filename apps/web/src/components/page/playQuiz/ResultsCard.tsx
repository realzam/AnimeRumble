			...
			<CardContent className='flex h-3/5 flex-col items-center justify-center'>
				{accuracy > 75 ? (
					<>
						...
						<div className='text-2xl flex flex-col font-semibold text-yellow-400'>
					...
					<>
						...
						<div className='text-2xl flex flex-col font-semibold text-stone-400'>
					...
					<>
						...
						<div className='text-2xl flex flex-col font-semibold text-yellow-800'>
