				...
				<div className='col-span-3 flex flex-col items-center justify-center space-y-4 p-4 font-semibold'>
					...
					<AnimeImageSoundtrackForm
						...
						onUploadError={() => {
							...
							toast({
								variant: 'destructive',
								title: 'Uh oh! No se pudo subir la imagen.',
					...
					<AnimeTrackSoundtrackForm
							...
							addSoundtrack.mutate(
								...
								},
								{
									...
									onError: (e) => {
										...
										toast({
											variant: 'destructive',
											title: 'Uh oh! No se pudo guardar la información',
											description:
						...
						onUploadError={() => {
							...
							toast({
								variant: 'destructive',
								title: 'Uh oh! No se pudo subir el Sountrack.',
								description: 'Hubo un problema al subir el Sountrack.',
							});
						}}
					/>
				</div>
